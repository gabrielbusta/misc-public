...
class TaskGraphGenerator:
    ...
    def _run(self):
        ...
        # hack to get the kinds topology
        links_dict = kind_graph.links_dict()
        for link in links_dict:
            links_dict[link] = list(links_dict[link])
        import json
        links_json = json.dumps(links_dict, indent=2)
        with open("/Users/gbustamante/workspace/clean/mozilla-central/mc-desktop-nightly-kinds.json", "w") as f:
            f.write(links_json)
