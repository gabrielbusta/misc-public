...
echo "deb [signed-by=/etc/apt/keyrings/repository.stage.productdelivery.nonprod.webservices.mozgcp.net.asc] https://repository.stage.productdelivery.nonprod.webservices.mozgcp.net/apt mozilla main" | sudo tee -a /etc/apt/sources.list.d/mozilla.list > /dev/null
